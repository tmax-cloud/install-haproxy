...
* 순서 : 
	...
	* LB Node 구축을 위해 필요한 파일들을 동일한 위치에 다운로드 받는다.
		```bash
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/A_LBNode/haproxy.cfg
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/A_LBNode/keepalived.conf
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/A_LBNode/lb_set_script.sh
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/A_LBNode/notify_action.sh
		```
