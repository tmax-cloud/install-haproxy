...
* 순서 :
	...
	* Node 구축을 위해 필요한 파일들을 동일한 위치에 다운로드 받는다.
		```bash
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/B_NoLBNode/haproxy_nolb.cfg
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/B_NoLBNode/keepalived_nolb.conf
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/B_NoLBNode/lb_set_script_nolb.sh
		wget https://raw.githubusercontent.com/tmax-cloud/install-haproxy/main/B_NoLBNode/notify_action.sh
		```
...
* 순서 :
	...
	* [K8S MASTER INSTALL GUIDE](https://github.com/tmax-cloud/install-k8s)
